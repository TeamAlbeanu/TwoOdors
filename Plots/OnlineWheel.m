function figData = OnlineWheel(action,figData,DataCount,StateToZero,thisTrial,thisLicks)

global BpodSystem S
%% Plot Parameters
labelx='Time(sec)'; 
labely='AngularSpeed deg/sec'; 
labelyy='Angle deg';
XLims = [S.GUI.TimeMin S.GUI.TimeMax];
xtickvalues= S.GUI.TimeMin:S.GUI.TimeMax;
...
set(figData.subplot,'XLim',XLims,'XTick',xtickvalues);
